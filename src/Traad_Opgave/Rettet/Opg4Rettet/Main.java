...
*/
        ...
        Common_Klasse common_klasse = new Common_Klasse();
        Thread tjener1 = new Tjener("jakob",common_klasse);
        Thread tjener2 = new Tjener("silas",common_klasse);
        Thread kok1 = new Kok("per", common_klasse);
        Thread kok2 = new Kok("hans", common_klasse);
